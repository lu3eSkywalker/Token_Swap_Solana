...
describe("Test", () => {
  ...
  it("Swap Token B for Token A", async () => {
    ...
    const userATAforTokenA = new web3.PublicKey("2SMbR29233K31GsL5dzyXixHHTzqjEMHkBTEB7ngnQrZ");
    const userATAforTokenB = new web3.PublicKey("Dp3oxBTFVjuf4uB5mb4xJQDLCaZQnNrc9Q2HxpLc8bki");
